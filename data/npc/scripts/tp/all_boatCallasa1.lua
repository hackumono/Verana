...
local travelNode = keywordHandler:addKeyword({'boss'}, StdModule.travel, {npcHandler = npcHandler, level = 1, cost = 0, destination = {x=33128, y=32497, z=7} })
        ...
        keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I can take you to Thais, Carlin, Venore, Abdendriel, Edron, Svargrond, Goroma, Ankrahmun, Darashia, Liberty Bay, Port Hope, Yalahar, Oken, Gengia, Pyre, Vikia, Ghala, Ghenov, Demona, Poh, boss, calassa, Zao and Razachai.'})
