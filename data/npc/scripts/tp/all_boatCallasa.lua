...
local travelNode = keywordHandler:addKeyword({'poh'}, StdModule.travel, {npcHandler = npcHandler, level = 1, cost = 0, destination = {x=32740, y=32269, z=6} })

local travelNode = keywordHandler:addKeyword({'calassa'}, StdModule.travel, {npcHandler = npcHandler, level = 1, cost = 0, destination = {x=31815, y=32617, z=6} })

local travelNode = keywordHandler:addKeyword({'boss'}, StdModule.travel, {npcHandler = npcHandler, level = 1, cost = 0, destination = {x=33128, y=32497, z=7} })



        keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I can take you to Thais, Carlin, Venore, Abdendriel, Edron, Svargrond, Goroma, Ankrahmun, Darashia, Liberty Bay, Port Hope, Yalahar, Oken, Gengia, Pyre, Vikia, Ghala, Ghenov, Demona, Poh, boss, calassa, Zao, Razachai and CALASSA.'})
