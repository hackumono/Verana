...
shopModule:addBuyableItem({'wild growth'}, 2269, 180,  1, 'magic wall rune')
...
shopModule:addBuyableItemContainer({'bp magic wall'},         2003, 2293, 200000,2000, 'bp magic wall')
...
shopModule:addBuyableItemContainer({'bp sd'},     2003, 2268, 200000,2000, 'bp sd')

shopModule:addBuyableItemContainer({'bp shp'}, 2000, 8704, 40000, 2000, 'backpack of small health potions')
shopModule:addBuyableItemContainer({'bp hp'}, 2000, 7618, 90000, 2000, 'backpack of health potions')
shopModule:addBuyableItemContainer({'bp mp'}, 2001, 7620, 100000, 2000, 'backpack of mana potions')
shopModule:addBuyableItemContainer({'bp shp'}, 2000, 7588, 200000, 2000, 'backpack of strong health potions')
shopModule:addBuyableItemContainer({'bp smp'}, 2001, 7589, 160000, 2000, 'backpack of strong mana potions')
shopModule:addBuyableItemContainer({'bp ghp'}, 2000, 7591, 380000, 2000, 'backpack of great health potions')
shopModule:addBuyableItemContainer({'bp gmp'}, 2001, 7590, 240000, 2000, 'backpack of great mana potions')
shopModule:addBuyableItemContainer({'bp gsp'}, 1999, 8472, 382000, 2000, 'backpack of great spirit potions')
shopModule:addBuyableItemContainer({'bp uhp'}, 2000, 8473, 620000, 2000, 'backpack of ultimate health potions')
