...
doPlayerSendTextMessage(cid,21,'Congratulations! You have reached level 150! As a special bonus Helysia administrators, you have received 25 premium points.') 
end 
return TRUE 
end
