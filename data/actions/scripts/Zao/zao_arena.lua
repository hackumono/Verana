...
if item.uid == 32145 then
 ...
 player1pos = {x=33098, y=31003, z=2, stackpos=253}
 player1 = getThingfromPos(player1pos)

 player2pos = {x=33099, y=31003, z=2, stackpos=253}
 player2 = getThingfromPos(player2pos)
  ...
  if player1level >= questlevel then
	...
	if 1==1 then
	demon1pos = {x=33081, y=31023, z=3}
        demon2pos = {x=33082, y=31023, z=3}
   ...
   doSummonCreature("Tirecz", demon2pos)
	...
	nplayer1pos = {x=33073, y=31023, z=3}
	nplayer2pos = {x=33073, y=31025, z=3}
