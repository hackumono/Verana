...
wall = {x=32622, y=31701, z=10, stackpos=0}
local getwall = getThingfromPos(wall) 
if item.uid == 17567 and item.itemid == 1945 then
   doTransformItem(item.uid,item.itemid+1)
   doTransformItem(getwall.uid,5770)
elseif item.uid == 17567 and item.itemid == 1946 then


   doTransformItem(item.uid,item.itemid-1)
   doTransformItem(getwall.uid,493)
bplayer = {x=32622, y=31701, z=10, stackpos=253}
