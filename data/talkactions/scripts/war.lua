...
if getPlayerStorageValue(cid,13008) < os.time()-30 then
setPlayerStorageValue(cid,13008,os.time())
if exhaustion.check(cid, 30031) then
    return FALSE
end
exhaustion.set(cid, 30031, 60)
	...
	if (getPlayerLevel(cid) <= 99) then
    	    doPlayerSendCancel(cid, "Musisz miec 100 poziom by wypowiedziec wojne.")
	    return true
	end
	local str = ""
